...
public class EventBusTest extends TestCase {
    ...
    public void testUnregisterNotLeaking() {
        EventBusTest subscriber = new EventBusTest();
        eventBus.register(subscriber);
        eventBus.unregister(subscriber);

        WeakReference<EventBusTest> ref = new WeakReference<EventBusTest>(subscriber);
        subscriber = null;
    ...
    private void assertSubscriberNotReferenced(WeakReference<EventBusTest> ref) {
        EventBusTest subscriberTest = new EventBusTest();
        WeakReference<EventBusTest> refTest = new WeakReference<EventBusTest>(subscriberTest);
        subscriberTest = null;
    ...
    public void testPostWithTwoSubscriber() {
        EventBusTest test2 = new EventBusTest();
        eventBus.register(this, String.class);
